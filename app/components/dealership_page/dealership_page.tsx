        ...
        <div className="flex justify-center min-h-screen">
            <div className="grid grid-cols-1 md:grid-cols-[2fr_3fr] w-full max-w-6xl">
                ...
                <div className="flex flex-col items-center bg-white pl-2">
                    ...
                    />
                    <div className="p-4 flex-grow w-full space-y-4">
                        <p className="text-center text-2xl font-bold text-gray-900 tracking-wider">
                ...
                <div className="flex flex-col bg-white space-y-2 pl-5">
                    ...
                    <div className="flex flex-col space-y-3">
                        ...
                        <div className="flex items-center text-lg text-gray-800">
                            ...
                            <a
                                href="tel:0929924078"
                                className="text-red-600 hover:text-red-800 font-semibold mr-2"
                            >
                                092.992.4078
                            </a>
                    ...
                    <ul className="space-y-0">
                        {[
                            ...
                            },
                            {
                                ...
                                description: "Với kinh nghiệm nhiều năm bán xe Mitsubishi, chúng tôi tin sẽ giúp quý khách chọn được chiếc xe ưng ý."
                            },
                            {
